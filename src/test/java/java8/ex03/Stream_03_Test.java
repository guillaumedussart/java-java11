...
public class Stream_03_Test {
    ...
    public void test_mapping() throws Exception {
        ...
        Map<Gender, String> result = customers.stream().sorted((c1,c2)->c1.getFirstname().compareTo(c2.getFirstname())).collect(Collectors.toMap(Customer::getGender,Customer::getFirstname, (g, c) -> g + "|" + c));
